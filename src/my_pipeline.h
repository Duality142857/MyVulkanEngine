...
public:
    ...
    void createSkyBoxPipeline(const std::string& _vertexShaderFile, const std::string& _fragmentShaderFile, VkPipelineLayout pipelineLayout, int textureArraySize=10)
    {
        vertexShaderFile=_vertexShaderFile;
        fragmentShaderFile=_fragmentShaderFile;
        MyShader vertexShader{rhi,vertexShaderFile,VK_SHADER_STAGE_VERTEX_BIT};
        ...
        VkPipelineRasterizationStateCreateInfo rasterizerStateCI=PipelineConfigFunctions::rasterizerStateCreateInfo(VK_POLYGON_MODE_FILL,VK_CULL_MODE_FRONT_BIT,VK_FRONT_FACE_COUNTER_CLOCKWISE);
